...
lazy val kafkaproducerservice = (project in file(kafkaProducerServiceKey))
  ...
  .settings(libraryDependencies ++= kafkaServiceDependencies)
...
lazy val k8readyservice = (project in file(k8ReadyServiceKey))
  .settings(k8ReadyServiceSettings: _*)
  .settings(libraryDependencies ++= k8ReadyServiceDependencies)
  .settings(removeDependencies: _*)
  .settings(k8ReadyServiceDockerSettings)
  .enablePlugins(AshScriptPlugin)
  .enablePlugins(AssemblyPlugin)
